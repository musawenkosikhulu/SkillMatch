...
export const CheckIcon = () => <IconBase className="text-teal-500"><polyline points="20 6 9 17 4 12" /></IconBase>;
...
export const LoaderIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={['animate-spin text-teal-500', className].filter(Boolean).join(' ')}>
